...
if __name__ == "__main__":
    ...
    imagem_de_entrada = 'IMAGEM ORIGINAL/gatinho1.png'
    arquivo_mif_de_saida = 'IMAGEM EM MIF/gatinho1_convertido.mif'
    arquivo_cinza_de_saida = 'IMAGEM CINZA/gatinho1_em_cinza.png'
