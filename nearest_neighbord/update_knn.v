...
//mede a diferença entre duas sequências de caracteres do mesmo comprimento, contando o número de posições em que os símbolos correspondentes são diferentes

//atualiza as distâncias mínimas entre a instância
// de teste e as de treino (fase de comparação).

//mantém uma lista dos k vizinhos mais próximos.

//*_0 e *_1 = duas portas independentes da memória de distâncias, 
//permitindo ler e escrever em paralelo → o que acelera o processo de 
...
module update_knn (
        ...
        ap_idle,
        ap_ready,
        test_inst_V,          //imagem a classificar
        train_inst_V,         //imagem do data set 
		  //memoria dual port
		  //permite ler um endereço ao mesmo tempo que escreve em outro
        min_distances_V_address0,
        min_distances_V_ce0,
        min_distances_V_we0,   //sinais de escrita
        min_distances_V_d0,    //endereços de leitura/escrita
        min_distances_V_q0,	 //valor lido da memória (distância antiga).
        min_distances_V_address1,
        min_distances_V_ce1,
        min_distances_V_we1,
        min_distances_V_d1,
        min_distances_V_offset   //deslocamento usado para indexar posições na memória de distâncias.
);
...
reg[5:0] min_distances_V_d0; //valoroes de distancia a serem gravados
...
assign r_V_fu_134_p2 = (train_inst_V_cast_fu_130_p1 ^ test_inst_V);    //caalcula a distância de Hamming entre test_inst_V e train_inst_V:
