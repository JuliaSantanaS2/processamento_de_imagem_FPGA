...
//KNN VOTE: modulo responsavel por lidar com votaçao (escolher qual classe mais persistente e guarda-la)
//Percorre os k vizinhos mais próximos armazenados.
//Compara distâncias e/ou faz uma votação.
//Decide qual é a classe final.
//Entrega o resultado em ap_return.

//classe:rótulo (label) do vizinho(de 0 a 9)
...
module knn_vote (
        ...
        ap_idle,
        ap_ready,
        knn_set_0_V_address0, //distancia de um vizinho
        knn_set_0_V_ce0,
        knn_set_0_V_q0,
        ap_return
);

parameter    ap_ST_fsm_state1 = 3'd1;  // espera ap_stars
parameter    ap_ST_fsm_state2 = 3'd2;  //varre elementos de knn_set
parameter    ap_ST_fsm_state3 = 3'd4;  //compara distancias e acumula resultados

input   ap_clk;
input   ap_rst;
input   ap_start;
output   ap_done;                   //sinaliza final 
output   ap_idle;                   //modulo ocioso
output   ap_ready;                  // pronto para nova execuçao
output  [3:0] knn_set_0_V_address0; //endereço atual, k<=16
output   knn_set_0_V_ce0;
input  [4:0] knn_set_0_V_q0;        //dado de saida da memoria,armazena a classe de cada vizinho
...
wire   [31:0] digit_recognized_cas_fu_65_p1;   //ativa quando ==10. Le knn_set_0_V (knn_set_0_V_q0).Cada valor e endereço para acessar memoria de vizinhos
...
reg   [31:0] min_sum_distances_reg_30;        //guarda menor distancia atual
...
reg   [3:0] ap_return_preg;             //guarda classe mais proxima ao fim da varredura
reg   [2:0] ap_NS_fsm;
